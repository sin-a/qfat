    ...
    def __init__(
        ...
        try:
            ...
            assert not isinstance(
                observation, collections.abc.Mapping
    ...
    def render(
        ...
        if mode == "human":
            ...
            return self.sim_robot.renderer.render_offscreen(
                width, height, mode="rgb_array", camera_id=camera_id
            )
        elif mode == "depth_array":
            assert width and height
            return self.sim_robot.renderer.render_offscreen(
                width, height, mode="depth_array", camera_id=camera_id
            )
        else:
