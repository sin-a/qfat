...
class SingleUR3XYLEFTFRONTEnv(MujocoEnv, utils.EzPickle):
    # class variables
    mujoco_xml_full_path = os.path.join(
        os.path.dirname(__file__), "assets/ur3/single_ur3_left_front_base.xml"
    )
    ...
    def reset_model(self):
        ...
        goal_x = 0.1 - 0.4 * np.random.rand()  # -0.3 ~ 0.1
