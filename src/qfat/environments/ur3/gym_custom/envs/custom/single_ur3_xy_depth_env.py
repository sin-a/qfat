...
class SingleUR3XYEnv(MujocoEnv, utils.EzPickle):
    ...
    def _define_class_variables(self):
        ...
        self.init_qpos[0 : self.ur3_nqpos] = np.array(
            [1.22096933, -1.3951761, 1.4868261, -2.01667739, 0.84679318, -0.00242263]
        )
    ...
    def step(self, a):
        ...
        is_inside_bound = self.is_inside_bound(
            self.curr_pos[0], self.curr_pos[1], -0.1, -0.6, 0.75, 0.60
        )
    ...
    def reset_model(self):
        ...
        block_pos_candi = np.array(
            [[0.15, -0.3], [0.3, -0.3], [0.15, -0.4], [0.3, -0.4], [0.225, -0.35]]
        )
