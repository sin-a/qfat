...
from gym_custom.spaces import Discrete
from gym_custom.spaces import MultiDiscrete
from gym_custom.spaces import MultiBinary
from gym_custom.spaces import Tuple
from gym_custom.spaces import Dict
