...
from gym_custom.spaces import Tuple, Dict
from gym_custom.vector.utils.spaces import _BaseGymSpaces
from gym_custom.vector.tests.utils import spaces

from gym_custom.vector.utils.shared_memory import (
...
@pytest.mark.parametrize(
    ...
    [
        None,
        pytest.param(
            "fork", marks=pytest.mark.skipif(is_python_2, reason="Requires Python 3")
        ),
        pytest.param(
            "spawn", marks=pytest.mark.skipif(is_python_2, reason="Requires Python 3")
        ),
    ],
