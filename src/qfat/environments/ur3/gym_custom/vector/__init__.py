...
from gym_custom.vector.vector_env import VectorEnv
...
def make(id, num_envs=1, asynchronous=True, wrappers=None, **kwargs):
    ...
    Returns
    -------
    env : `gym_custom.vector.VectorEnv` instance
        The vectorized environment.

    Example
    -------
    >>> import gym_custom
    >>> env = gym_custom.vector.make('CartPole-v1', 3)
    >>> env.reset()
    array([[-0.04456399,  0.04653909,  0.01326909, -0.02099827],
          ...
          dtype=float32)
    """
    from gym_custom.envs import make as make_
